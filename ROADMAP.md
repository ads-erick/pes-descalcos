...
- [x] **Prévia sem pulo no craque** — na carta grande do lado da lista (desktop), a do craque ficava uns 14px mais baixa que as outras, porque só ela reservava o espaço da tarja em cima. Agora todas reservam o mesmo espaço (fora da imagem que se copia/baixa), e a carta fica parada ao trocar (#47)
