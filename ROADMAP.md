...
- [x] **Foto pelo círculo do avatar** — no cadastro e na edição, o próprio círculo da foto abre a escolha do arquivo, que cai direto no enquadramento. Um "trocar foto" aparece por cima no hover, no foco de teclado e ao tocar, e um selo de câmera fica sempre no canto (no celular não tem hover pra avisar). O botão "Trocar" saiu; ficaram "Enquadrar" e "Remover" (#42)
